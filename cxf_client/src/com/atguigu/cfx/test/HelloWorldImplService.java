 ...
 * 2017-05-27T22:50:14.522+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:9999/cxf_server?wsdl",
                  targetNamespace = "http://test.cfx.atguigu.com/") 
public class HelloWorldImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://test.cfx.atguigu.com/", "HelloWorldImplService");
    public final static QName HelloWorldImplPort = new QName("http://test.cfx.atguigu.com/", "HelloWorldImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9999/cxf_server?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9999/cxf_server?wsdl");
        }
        WSDL_LOCATION = url;
    }
